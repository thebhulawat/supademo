...
function markPage() {
  ...
  // Select all elements, including those in overlays
  ...
  var items = Array.from(allElements)
    ...
    .map(function (element) {
      ...
      var visibleRects = Array.from(rects).filter((rect) => {
      ...
      var area = visibleRects.reduce((acc, rect) => {
        const visibleRect = {
        ...
        return acc + visibleWidth * visibleHeight;
      }, 0);
